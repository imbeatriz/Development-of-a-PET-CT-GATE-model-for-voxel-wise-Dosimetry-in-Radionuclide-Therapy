...
def run_calculation():
    ...
    try:
        ...
        # Get the rounded value for display
        current_su_rounded = round(current_su, 1)
        
        # Check if current SU is STRICTLY LESS THAN target SU (2.0%)
        # We need to compare the actual value, not the rounded value
        if current_su < TARGET_SU:
            ...
            # current_su >= TARGET_SU, need more runs
            ...
            scaling_text = (
                ...
                f"  Multiplier M = {M:.3f}\n"
                f"  Required total primaries = {N_required:.2e}\n"
        ...
        results = {
            ...
            "Total PTV Voxels AD > 80 Gy": n_vox_high,
            ...
            "Current MC primaries": f"{N_current:.2e}",
